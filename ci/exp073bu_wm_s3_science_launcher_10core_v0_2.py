...
SCHEMA='dsir.exp073bu.wm_s3.science_launcher.10core.v0.2'
PASS_TOKEN='PASS_EXP073BU_WM_S3_FRESH_AB_EXACT_REPEATABILITY_10CORE_V0_2'
...
THREAD_ENV={'OMP_NUM_THREADS':'10','OPENBLAS_NUM_THREADS':'1','MKL_NUM_THREADS':'1','NUMEXPR_NUM_THREADS':'1'}
...
def main():
    ...
    rec={'schema':SCHEMA,'classification':None,'raw_token':None,'source_head':args.source_head,'contract_fingerprint':args.contract_fingerprint,'checkpoint_namespaces':NAMESPACES,'science_gate_scored':False,'wm_s3_authority_created':False,'historical_wm_s3_numerical_import':False,'no_tolerance_rescue':True,'execution_workers':10,'comparison':None,'replicas':{},'logs':{}}
    try:
