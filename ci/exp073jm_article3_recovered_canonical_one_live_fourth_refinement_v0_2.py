...
def validate_activation(path: str | Path) -> dict:
    ...
    # No activation predicates beyond the frozen branch token + independent verification.
...
def execute(a) -> dict:
    ...
    # Recompute the exact response-blind observational request plan before CLASS.
    ...
    # Record exact inherited four-suite response-call boundaries with no CLASS.
    ...
    # Reuse the already-audited requested-node/cubic/finite-difference evaluator.
    ...
    return {
        "schema": "EXP073JM_ARTICLE3_RECOVERED_CANONICAL_ONE_LIVE_FOURTH_REFINEMENT_RESULT_V0_2",
        "experiment": "Exp073JM",
        ...
        "token": (
            ...
            if converged
            else "PASS_EXP073JM_RECOVERED_CANONICAL_ONE_LIVE_FOURTH_REFINEMENT_NOT_CONVERGED_V0_2"
        ),
    }
...
def main():
    ...
    try:
        ...
        result = {
            ...
            "token": "EXP073JM_RECOVERED_INVALID_INFRA_V0_2",
        }
