...
def vecs(root,field):
    ...
    for n,s in e71i.K2_STEPS.items():
        r,_=e71i.response_vector(root,n+'_','ref_',field); ks.append(r/s)
    cs,_=e71i.response_vector(root,'cs1em7_','gdm0_',field); cv,_=e71i.response_vector(root,'cv1em7_','gdm0_',field)
...
def main():
    ...
    out={'experiment':'Exp071J','preregistration_commit':'306c19a4286ffc459fc2886097a8b70fa6df89e9','threshold_deg':TH,'gate_state':{'G7':'OPEN','G8':'OPEN','G9':'OPEN'}}
    try:
        ...
        kt,cs,cv=vecs(root/'fresh/k2','t_tot')
        ...
        kb,csb,cvb=vecs(root/'fresh/k2','t_b'); pbs=[pz(x) for x in kb]; pcsb=pz(csb); pcvb=pz(cvb)
