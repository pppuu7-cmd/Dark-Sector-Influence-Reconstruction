...
IMPLEMENTATION_CRITIC = ROOT / "docs/dsir4/authority/LAYERB_BETA_V0_26_R1_MINIMAL_SCIENTIFIC_RESPONSE_FROM_NUMERICAL_WITNESSES_IMPLEMENTATION_STATIC_CRITIC_V0_2.json"
EXECUTION_AUTHORITY = ROOT / "docs/dsir4/authority/LAYERB_BETA_V0_26_R1_MINIMAL_SCIENTIFIC_RESPONSE_FROM_NUMERICAL_WITNESSES_EXECUTION_AUTHORITY_V0_2.json"
WORKFLOW = ROOT / ".github/workflows/dsir-v026-r1-minimal-scientific-response-from-numerical-witnesses-v0-2.yml"
LAUNCH_MARKER = ROOT / "docs/dsir4/launch/LAYERB_BETA_V0_26_R1_MINIMAL_SCIENTIFIC_RESPONSE_FROM_NUMERICAL_WITNESSES_V0_2.launch.json"
...
def api_json(url: str, token: str) -> dict:
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "dsir-minimal-scientific-response-v0-2",
        },
    )
    try:
...
def download_artifact_zip(api: str, repo: str, token: str, artifact_id: int) -> bytes:
    ...
    storage = urllib.request.Request(
        location,
        headers={"Accept": "application/octet-stream", "User-Agent": "dsir-minimal-scientific-response-v0-2"},
    )
