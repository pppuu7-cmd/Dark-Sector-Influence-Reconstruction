...
/*
 * Exp073CR v0.1 authoritative ll3-range helper.
 *
 * Exact-control-flow analogue of the frozen Exp073CA complete-band helper:
 ...
 * Only the independent ll3 output domain and output storage are sliced.
 *
 * nthreads MUST equal 1. Resource parallelism belongs outside this helper.
 * No arithmetic reduction is allowed when shards are reassembled.
 */
