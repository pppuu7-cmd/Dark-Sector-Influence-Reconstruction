...
def main() -> None:
    ...
    # Estimate derivative d r / d cs2 near the zero-closure point by averaging
    # scaled responses over the deliberately small local calibration subset.
    ...
    # k^2 pressure-gradient sanity check on the local tangent. This is a known
    # perturbative control, not a discovery claim.
