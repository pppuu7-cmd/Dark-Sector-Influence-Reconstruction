...
def main():
 ...
 if ident.get('parent_authority_git_blob')!=PARENT or ident.get('canonical_32769_node_sha256')!=NODE or ident.get('canonical_32769_text_sha256')!=TEXT or ident.get('class_build_authority_git_blob')!=BUILD or ident.get('terminal_contract_git_blob')!=TERMINAL:e.append('contract_identity')
