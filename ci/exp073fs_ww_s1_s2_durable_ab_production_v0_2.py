...
WRAPPER = Path(__file__).with_name('exp073fs_ww_s1_s2_durable_ab_production_v0_1.py')
spec = importlib.util.spec_from_file_location('exp073fs_wrapper_v01', WRAPPER)
if spec is None or spec.loader is None:
    raise RuntimeError('cannot load frozen Exp073FS v0.1 wrapper')
...
def public_bpw_from_serialized_workspace(wp: Path, out_dir: Path):
    ...
    del wins,full_arr,ee_arr,w2; gc.collect()
