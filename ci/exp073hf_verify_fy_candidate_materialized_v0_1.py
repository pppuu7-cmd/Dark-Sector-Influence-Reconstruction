...
PASS='PASS_EXP073FY_WW_S2_S3_FILEBACKED_AB_EXACT_REPEATABILITY_V0_1'
...
def main():
 ...
 for rep in ('A','B'):
  ...
  assert rec['source_pair']=='S2->S3' and rec['ordered_source_indices']==[2,3] and rec['same_field_object_handoff'] is False and rec['historical_ww_numerical_import'] is False and rec['other_replica_output_read'] is False
  assert src['ordered_source_indices']==[2,3] and src['reconstruction_counts']=={'s2':1,'s3':1} and src['same_source_map_both_sides'] is False
 ...
 print('PASS_EXP073FZ_WW_S2_S3_FILEBACKED_PROVENANCE_ADMISSION_V0_1')
 print('classification=SCIENTIFIC_AUTHORITY_ADMITTED')
 print('ww_s2_s3_authority_created=true')
