...
BUILD_AUTH_PASS = "LAYERB_32769_CLASS_CAPACITY_BUILD_ENVELOPE_PASS_PLUS_0_PLUS_0"
...
def validate_build_authority(path: str | Path) -> dict:
    ...
    if (
        ...
        raise RuntimeError("32769 CLASS build authority invalid")
    return d
...
def execute(a) -> dict:
    ...
    jo = load_module("exp073jo_parent_for_32769_resource", a.jo_script)
    jj = load_module("exp073jj_parent_for_32769_resource", a.jj_script)
    if (
        jo.H != H
    ...
    return {
        "schema": "LAYERB_32769_RESPONSE_BLIND_RESOURCE_LIFECYCLE_PILOT_RESULT_V0_1",
