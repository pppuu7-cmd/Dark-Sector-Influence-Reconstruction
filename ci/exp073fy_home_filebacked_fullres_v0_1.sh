...
for old,new in [('exp073fs','exp073fy'),('Exp073FS','Exp073FY'),('EXP073FS','EXP073FY'),('ww_s1_s2','ww_s2_s3'),('ww-s1-s2','ww-s2-s3'),('WW_S1_S2','WW_S2_S3'),('S1->S2','S2->S3'),('[1,2]','[2,3]')]:
    ...
    s=s.replace(old,new)
# Shell-level invariants only. Scientific source-pair/index literals are
# frozen and audited in the Python driver; requiring them to appear in the
# generated shell was an invalid lexical assumption and caused pre-science
# failure before the driver could run.
