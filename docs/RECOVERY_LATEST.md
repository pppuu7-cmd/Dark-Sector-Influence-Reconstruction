...
Newest immutable authority note: `docs/recovery/RECOVERY_2026-09-10_ARTICLE3_JO_PREFLIGHT_RUNNING_V81.md`, creation commit `7d72c0cd7dba95161d87ec6a18e867d2fe195e07`. Earlier notes remain immutable history.
...
Prepared recovery workflow `.github/workflows/exp073jo-article3-jl-durable-response-checkpoint-recovery-v0-1.yml`, commit `a2ea07ff5a5bd4060cb3c7b7230b398dde202f08`, is deliberately `workflow_dispatch`-only and MUST NOT be activated before independently verified JO preflight PASS authority exists.
...
## Exact next action
Terminal-consume JO preflight `34504474368 / 102963111387`. Valid PASS -> independently verify artifact ZIP/result/capacity hashes, commit durable JO preflight authority, then enable and launch exactly one prepared checkpointed JL recovery. Infrastructure FAIL -> diagnose first causal process defect; recovered JL remains forbidden. No tolerance rescue.
