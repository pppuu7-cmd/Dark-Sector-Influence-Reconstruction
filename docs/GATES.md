...
|---|---|---|
| G0 | LambdaCDM embedding reproduces reference observables | PARTIAL — background/growth controls pass; full Boltzmann reference pending |
...
| G3B | Control classes embedded beyond background | PARTIAL — LambdaCDM, smooth wCDM, thermal WDM, designer-f(R) numerical linear controls; IDE/GDM closures pending |
