...
\newcommand{\placeholderfig}[1]{%
  \fbox{\parbox[c][0.25\textheight][c]{0.88\textwidth}{\centering #1\\[4pt]Generate with \texttt{scripts/publications/make\_dsir2\_figures\_v0\_4.py}.}}%
}
...
\date{Working manuscript v0.5 / LaTeX assembly v0.3 --- 28 August 2026}
...
\begin{equation}
\begin{gathered}
\text{representation}\rightarrow\text{resolvability}\rightarrow\text{channel/operator}\rightarrow\text{ray/line/subspace},\\
\text{metric}\rightarrow\text{physical support}\rightarrow\text{finite observation operator}\rightarrow\text{observational quotient}.
\end{gathered}
\end{equation}
...
\input{table1_terminal_comparison.tex}
...
\begin{figure*}[t]
\centering
\IfFileExists{\figdir/dsir2_figure1_k2_specificity_hierarchy_v0_4.pdf}{\includegraphics[width=0.96\textwidth]{\figdir/dsir2_figure1_k2_specificity_hierarchy_v0_4.pdf}}{\placeholderfig{Figure 1: K2 static ambiguity, positive temporal/velocity ray separation, and nuisance-line reversal.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure2_k1_representation_kernel_v0_4.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure2_k1_representation_kernel_v0_4.pdf}}{\placeholderfig{Figure 2: K1 transfer-only exact kernel and velocity-power recovery.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure3_support_admissibility_v0_4.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure3_support_admissibility_v0_4.pdf}}{\placeholderfig{Figure 3: provider completeness versus finite-observation admissibility.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure4_fail_closed_hierarchy_v0_4.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure4_fail_closed_hierarchy_v0_4.pdf}}{\placeholderfig{Figure 4: fail-closed DSIR response-specificity hierarchy.}}
...
The velocity chain binds exact CLASS source commits in the repository provenance ledger, while the literature citation uses CLASS II, arXiv:1104.2933 \citep{BlasLesgourguesTram2011CLASSII}. Figures are generated from \texttt{DSIR2\_FIGURE\_NUMERIC\_MANIFEST\_V0\_1.json}; the v0.4 generator reuses the accepted v0.3 visual construction and changes only serialization metadata/IDs to permit deterministic release QA. It does not alter scientific values, labels, thresholds, geometry, or classifications.

\input{table2_provenance.tex}
