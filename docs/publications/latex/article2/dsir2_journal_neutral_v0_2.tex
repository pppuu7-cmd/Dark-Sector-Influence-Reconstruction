...
\newcommand{\placeholderfig}[1]{%
  \fbox{\parbox[c][0.25\textheight][c]{0.88\textwidth}{\centering #1\\[4pt]Generate with \texttt{scripts/publications/make\_dsir2\_figures\_v0\_3.py}.}}%
}
...
\date{Working manuscript v0.5 / LaTeX assembly v0.2 --- 28 August 2026}
...
\begin{figure*}[t]
\centering
\IfFileExists{\figdir/dsir2_figure1_k2_specificity_hierarchy_v0_3.pdf}{\includegraphics[width=0.96\textwidth]{\figdir/dsir2_figure1_k2_specificity_hierarchy_v0_3.pdf}}{\placeholderfig{Figure 1: K2 static ambiguity, positive temporal/velocity ray separation, and nuisance-line reversal.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure2_k1_representation_kernel_v0_3.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure2_k1_representation_kernel_v0_3.pdf}}{\placeholderfig{Figure 2: K1 transfer-only exact kernel and velocity-power recovery.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure3_support_admissibility_v0_3.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure3_support_admissibility_v0_3.pdf}}{\placeholderfig{Figure 3: provider completeness versus finite-observation admissibility.}}
...
\begin{figure}[t]
\centering
\IfFileExists{\figdir/dsir2_figure4_fail_closed_hierarchy_v0_3.pdf}{\includegraphics[width=0.96\linewidth]{\figdir/dsir2_figure4_fail_closed_hierarchy_v0_3.pdf}}{\placeholderfig{Figure 4: fail-closed DSIR response-specificity hierarchy.}}
...
The velocity chain binds exact CLASS source commits in the repository provenance ledger, while the literature citation uses CLASS II, arXiv:1104.2933 \citep{BlasLesgourguesTram2011CLASSII}. Figures are generated from \texttt{DSIR2\_FIGURE\_NUMERIC\_MANIFEST\_V0\_1.json}; the v0.3 plotting script changes layout only and does not alter scientific values or classifications.
